  ...
  return (
    <div id="App">
      <img
        id="Logo"
        src={logo}
        alt="Logotipo do serviço de streaming Najuflix"
      />
      ...
      <div className="search">
        <input
          ...
          placeholder={
            idioma ===
            "./assets/bandeira-do-brasil-forma-redonda_445068-3081.avif"
              ? "Pesquise por filmes"
              : idioma === "en"
                ? "Search for movies"
                : "Buscar películas"
      ...
      <Rodape link={"https://github.com/AnnaJuMagaC"}>NajuMagaC</Rodape>
    </div>
  );
};
